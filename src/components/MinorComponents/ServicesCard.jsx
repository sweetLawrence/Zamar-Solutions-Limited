    ...
    <div className="service_card">
      ...
      <div className="content_section">
        <div className="content">
          ...
          itaque deleniti voluptatibus, dicta labore. At eum dignissimos hic
          nostrum sunt eaque tempore sit totam alias! Temporibus ab, vitae
          fugiat consectetur consequatur quae eveniet eaque quaerat, quod ipsa
